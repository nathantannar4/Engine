...
public protocol ViewInputsCondition {
    static func evaluate(_ inputs: _GraphInputs) -> Bool
}

extension ViewInputsCondition where Self: ViewInputFlag {
    /// Evaluates to `true` when the input value is `true`
    public static func evaluate(_ inputs: _GraphInputs) -> Bool {
...
extension View {
    ...
    @inlinable
    public func input<Input: ViewInput>(_: Input.Type) -> some View {
